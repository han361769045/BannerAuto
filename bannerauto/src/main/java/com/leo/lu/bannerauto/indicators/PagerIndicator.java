package com.leo.lu.bannerauto.indicators;
...
import com.leo.lu.bannerauto.InfinitePagerAdapter;
 ...
 * <p>
 * Thanks to: https://github.com/daimajia/AndroidImageSlide
 */
...
public class PagerIndicator extends LinearLayout implements ViewPager.OnPageChangeListener {
    ...
    /**
     * This value is from {@link com.leo.lu.bannerauto.InfinitePagerAdapter} getRealCount() represent
     * <p>
     ...
     *
     * @param shape can set, oval and rect.
     */
     ...
     *
     * @param visibility Visibility or Invisible
     */
    ...
    public void onPageSelected(int position) {
        ...
        if (((InfinitePagerAdapter) mPager.getAdapter()).getRealCount() == 0) {
            return;
        }
        position = ((InfinitePagerAdapter) mPager.getAdapter()).getCurrentPosition(position);
